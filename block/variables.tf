...
variable "data_datastore" {
  type        = string
  description = "Storage pool where data disk of the machine will live."
  default     = "local-lvm"
}
...
variable "data_disk_device" {
  type        = string
  description = "Device for Disk e.g. /dev/vdb"
  default     = "/dev/vdb"
}
...
variable "data_disk_fstype" {
  type        = string
  description = "Filesystem-Type for Disk e.g. ext4"
  default     = "ext4"
}

variable "data_disk_mount" {
  type        = string
  description = "Mountpoint for Data-Disk"
